...
},
{
  ...
  { "code": "cons_cotontige", "nom": "Fini les cotons jetables, mais il existe des alternatives.", "nom_en": "No more disposable cottons, but there are alternatives.", "descr": "Par ordre de préférence :<br/> - nettoyage manuel (pour éviter de retirer le cérumen);<br/>- les cures-oreilles (boucle en métal);<br/>- les cotons tiges lavables;<br/>- les oriculi, qui sont des cures-oreille en bambou (peuvent gratter à la longue).<br/>", "descr_en": "In order of preference: <br/> - manual cleaning (to avoid removing earwax); <br/> - earpicks (metal buckle); <br/> - washable cotton swabs; <br/> - oriculi, which are bamboo ear cures (can scratch over time). <br/>" },
  { "code": "cons_papiercadeau", "nom": "Remplacer le papier cadeau jetable.", "nom_en": "Replace the disposable gift wrap.", "descr": "Des techniques de pliages et nouage de tissu (technique japonaise traditionnelle appelée furoshiki) vous permettront d’envelopper intelligement les cadeaux.", "descr_en": "Folding and knotting techniques (a traditional Japanese technique called furoshiki) will allow you to intelligently wrap the gifts." },
  {
