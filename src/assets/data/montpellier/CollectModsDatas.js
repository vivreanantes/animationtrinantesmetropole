var _collectModsDatas = [{
	...
	"cons" : "cons_verre,cons_sans_bouchon_ni_couvercle,",
	"icone" : "modco",
	...
	"modesCollecte" : "false",
	"descr" : "<UL>Les déchets suivants sont admis : déblais, gravats, encombrants, appareils électriques, déchets toxiques (peinture, vernis, colle, diluants, batteries, huiles moteur), déchets verts, bouteilles et flacons plastiques, papiers, cartons, cartonnettes, verre ménager (pôts, bouteilles), métal.<BR/>.",
	"descr_en" : "<UL> The following shall be permitted: rubble, rubble, bulky, electrical appliances, toxic waste (paint, varnish, glue, thinners, batteries, motor oil), green waste, plastic bottles, paper, cardboard, cardboards, glass household (Pots, bottles), metal. <BR/>.",
	"icone" : "modco",
